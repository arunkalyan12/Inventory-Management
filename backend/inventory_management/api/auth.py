...
from ..db.mongo_queries import insert_user, get_user_by_email
...
def signup(data: SignupRequest, response: Response):
    ...
    # --- Local event handling can go here if needed ---
    # e.g., log signup, trigger internal functions
    # log_user_signup(user)  # Optional
